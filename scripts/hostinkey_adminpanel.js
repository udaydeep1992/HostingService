$(document).ready(function () {
    ...
    function UpdateMasternodeActivity() {
        $.get("ajax.php", {isMasternode: ""}, function (data) {
            ...
            if (isEnabled !== $(".masternode-switch").is(':checked')) {
                ...
                var init2 = new Switchery(elem2, {disabled: true, color: "#FFED00", secondaryColor: "#efefef"});
                elem2.onchange = function () {
                    plsRestartDaemon();
                    setMasternodeEnable($(".masternode-switch").is(':checked'));
                };
    ...
    function restartDaemon() {
        ...
        toastr.warning("Re-Starting daemon. Please wait.");
    ...
    function reindexDaemon() {
        ...
        toastr.warning("Re-Indexing daemon. Please wait.");
    ...
    function resetServer() {
        ...
        toastr.warning("Re-Setting Daemon. Please wait.");
